    ...
    return AppScaffold(
      ...
      body: BlocBuilder<DetailsFoodCubit, DetailsFoodState>(
        builder: (context, state) {
            ...
            return Padding(
              ...
              child: HomeErrorWidget(
                ...
                onRetry: () => context.read<DetailsFoodCubit>().doIntent(
                  LoadDetailsFoodEvent(state.mealId),
                ),
              ),
            );
          }
          ...
          final details = detailsState.data!;
  ...
  Widget _buildLoadingState() {
    return SingleChildScrollView(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          HomeSectionsShimmer.detailsFoodHeroShimmer(),
          Padding(
            padding: EdgeInsets.all(16.w),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                HomeSectionsShimmer.detailsFoodIngredientsShimmer(),
                SizedBox(height: 24.h),
                HomeSectionsShimmer.detailsFoodSectionShimmer(),
              ],
            ),
          ),
        ],
