...
void main() {
  ...
  group('signup', () {
    ...
    const tSignupResponse = signup.SignupResponse(
    ...
    test(
      ...
      () async {
        ...
        // assert
        expect(result, isA<SuccessBaseResponse<signup.SignupResponse>>());
    ...
    test('should return ErrorBaseResponse when DioException occurs', () async {
      ...
      // assert
      expect(result, isA<ErrorBaseResponse<signup.SignupResponse>>());
